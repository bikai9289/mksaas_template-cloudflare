...
description: Privacy policy for VideoPrompThub
created_at: 2025-10-24
---

## Introduction

Welcome to VideoPrompThub, an all-in-one AI generation platform where you can explore and experience various video prompts. At VideoPrompThub, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using VideoPrompThub:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use VideoPrompThub, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access VideoPrompThub, such as device type, operating system, and browser type.
...
**Copyright Owner**: [videoprompthub.com](https://videoprompthub.com)
**Email**: [xx@com](mailto:xx@com)

By using VideoPrompThub, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
